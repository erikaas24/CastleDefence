...
def generateBot(ticks, wave):
    ...
    if enemiesPerWave[wave][0] > len(Helicopter.chopperList):
        ...
        if ticks - chopperCooldowns[wave] >= lastChopperGeneratedTick:
            ...
            randomYVerdi1 = randint(200, HEIGHT - Chopper.height - 10)
            newBot = Helicopter(WIDTH-107, randomYVerdi1, BLACK, 80, 50, 3, 1_000, "chopper", 50, "./Bilder/heli.png")
    ...
    if enemiesPerWave[wave][1] > len(Tank.tankList):
        if ticks - tankCooldowns[wave] >= lastTankGeneratedTick:
            ...
            randomYVerdi2 = randint(130,145)
            newBot2 = Tank(WIDTH + 50, randomYVerdi2, BLACK, 100, 70, 5, 3_000, "tank", 50, "./Bilder/tank-oga/wholetank/key-frames/right/right-1.png")
            newBot2.images = Tank1.images
